...
const STORAGE_KEY = 'vestOrder.form.v1';
...
export default function VestOrderPage(): React.ReactElement {
  ...
  const saveDraft = React.useCallback(() => {
    ...
    try {
      ...
      localStorage.setItem(STORAGE_KEY, JSON.stringify(data));
      saveDraftUtil('vestOrder', data, 'vest', data.fabricCode);
    } catch {}
  }, []);
  ...
  return (
    <div className="container-card">
      ...
      <h1 className="text-[22px] font-semibold my-2">ベストオーダー入力</h1>

      <form ref={formRef} id="vestOrderForm" className="grid grid-cols-[220px_1fr] gap-x-5 gap-y-4">
        ...
        <fieldset className="contents">
          ...
          <div>
            <select className="w-full h-11 rounded-lg border px-4 text-sm bg-gray-50 focus:outline-none focus:border-slate-800 focus:bg-white focus:shadow-[0_0_0_3px_rgba(31,41,55,0.08)]" id="patternNo" name="patternNo" defaultValue="">
              ...
              <option value="VEST001">VEST001 - ベストパターン1</option>
              <option value="VEST002">VEST002 - ベストパターン2</option>
            </select>
          </div>
        </fieldset>
        ...
        <fieldset className="contents">
          ...
          <div>
            <select className="w-full h-11 rounded-lg border px-4 text-sm bg-gray-50 focus:outline-none focus:border-slate-800 focus:bg-white focus:shadow-[0_0_0_3px_rgba(31,41,55,0.08)]" id="button" name="button" defaultValue="">
              ...
              <option value="V1">V1 - ベスト釦1</option>
              <option value="V4">V4 - ベスト釦2</option>
            </select>
          </div>
        </fieldset>
        ...
        <fieldset className="contents">
          ...
          <div className="w-full rounded-lg border px-4 py-3 bg-gray-50">¥60,000（税込）</div>
        </fieldset>
