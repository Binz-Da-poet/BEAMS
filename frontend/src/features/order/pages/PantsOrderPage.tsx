...
const STORAGE_KEY = 'pantsOrder.form.v1';
...
export default function PantsOrderPage(): React.ReactElement {
  ...
  const saveDraft = React.useCallback(() => {
    ...
    try {
      ...
      localStorage.setItem(STORAGE_KEY, JSON.stringify(data));
      saveDraftUtil('pantsOrder', data, 'pants', data.fabricCode);
    } catch {}
  }, []);
  ...
  return (
    <div className="container-card">
      ...
      <h1 className="text-[22px] font-semibold my-2">パンツオーダー入力</h1>

      <form ref={formRef} id="pantsOrderForm" className="grid grid-cols-[220px_1fr] gap-x-5 gap-y-4">
        ...
        <fieldset className="contents">
          ...
          <div className="w-full rounded-lg border px-4 py-3 bg-gray-50">¥80,000（税込）</div>
        </fieldset>
