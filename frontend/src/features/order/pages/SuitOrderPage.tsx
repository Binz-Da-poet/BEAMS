...
const STORAGE_KEY = 'suitOrder.form.v1';
...
export default function SuitOrderPage(): React.ReactElement {
  ...
  const saveDraft = React.useCallback(() => {
    ...
    try {
      ...
      localStorage.setItem(STORAGE_KEY, JSON.stringify(data));
      saveDraftUtil('suitOrder', data, 'suit', data.fabricCode);
    } catch {}
  }, []);
  ...
  return (
    <div className="container-card">
      ...
      <h1 className="text-[22px] font-semibold my-2">スーツオーダー入力</h1>

      <form ref={formRef} id="suitOrderForm" className="grid grid-cols-[220px_1fr] gap-x-5 gap-y-4">
        ...
        <fieldset className="contents">
          <label className="self-center">
            ジャケットパターンNo <span className="text-red-500">*</span>
          </label>
          <div>
            <select className="w-full h-11 rounded-lg border px-4 text-sm bg-gray-50 focus:outline-none focus:border-slate-800 focus:bg-white focus:shadow-[0_0_0_3px_rgba(31,41,55,0.08)]" id="jacketPatternNo" name="jacketPatternNo" defaultValue="">
              <option value="" disabled>
                ------------検索してください------------
              </option>
              <option value="SUIT001">SUIT001 - スーツジャケットパターン1</option>
              <option value="SUIT002">SUIT002 - スーツジャケットパターン2</option>
            </select>
          </div>
        </fieldset>
        ...
        <fieldset className="contents">
          <label className="self-center">
            パンツパターンNo <span className="text-red-500">*</span>
          </label>
          <div>
            <select className="w-full h-11 rounded-lg border px-4 text-sm bg-gray-50 focus:outline-none focus:border-slate-800 focus:bg-white focus:shadow-[0_0_0_3px_rgba(31,41,55,0.08)]" id="pantsPatternNo" name="pantsPatternNo" defaultValue="">
              <option value="" disabled>
                ------------検索してください------------
              </option>
              <option value="PANTS001">PANTS001 - パンツパターン1</option>
              <option value="PANTS002">PANTS002 - パンツパターン2</option>
            </select>
          </div>
        </fieldset>
        ...
        <fieldset className="contents">
          <label className="self-center">ジャケット釦品番</label>
          <div>
            <select className="w-full h-11 rounded-lg border px-4 text-sm bg-gray-50 focus:outline-none focus:border-slate-800 focus:bg-white focus:shadow-[0_0_0_3px_rgba(31,41,55,0.08)]" id="jacketButton" name="jacketButton" defaultValue="">
              <option value="" disabled>
                ------------検索してください------------
              </option>
        ...
        <fieldset className="contents">
          <label className="self-center">パンツ釦品番</label>
          <div>
            <select className="w-full h-11 rounded-lg border px-4 text-sm bg-gray-50 focus:outline-none focus:border-slate-800 focus:bg-white focus:shadow-[0_0_0_3px_rgba(31,41,55,0.08)]" id="pantsButton" name="pantsButton" defaultValue="">
              <option value="" disabled>
                ------------検索してください------------
              </option>
              <option value="BF-2">BF-2 - パンツ釦1</option>
              <option value="NO.2">NO.2 - パンツ釦2</option>
            </select>
          </div>
        </fieldset>
        ...
        <fieldset className="contents">
          ...
          <div className="w-full rounded-lg border px-4 py-3 bg-gray-50">¥200,000（税込）</div>
        </fieldset>
